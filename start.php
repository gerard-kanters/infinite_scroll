 ...
 */
$contexts = array('search','index','profile','photos','admin','tracker', 'webdav' );
...
function infinite_scroll_init() {
	...
	if (elgg_get_plugin_setting('pagination_type') != 'classic') {
	...
	if (elgg_get_plugin_setting('pagination_type') == 'automatic') {
